...
export default function Experience() {
  return (
    <>
      <Head
        title="Experiencia Laboral | Matias M. Monasterio"
        description="Mi experiencia y desarrollo en diferentes áreas y compañías"
      />
                ...
                <Box mb={8}>
                  ...
                  <Box mb={6}>
                    ...
                    <Text mb={1}>
                      ...
                      proyectos, desarrollo de productos para gestión de
                      usuarios, resolución de incidentes relacionados a los
                      sistemas actuales.
                    </Text>
